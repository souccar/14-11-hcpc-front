    ...
    getUiIconBySeverity(severity: abp.notifications.severity): string {
        switch (severity) {
            case abp.notifications.severity.SUCCESS:
                return 'simple-icon-check text-success';
            case abp.notifications.severity.WARN:
                return 'simple-icon-exclamation text-warning';
            case abp.notifications.severity.ERROR:
                return 'simple-icon-close text-danger';
            case abp.notifications.severity.FATAL:
                return 'fa fa-bomb';
            case abp.notifications.severity.INFO:
            default:
                return 'simple-icon-info text-info';
        }
    }
